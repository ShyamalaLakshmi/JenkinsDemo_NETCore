    ...
    public class TokenController : ControllerBase
    {
        ...
        public async Task<IActionResult> TokenExchange(OpenIdConnectRequest request)
        {
            if (!request.IsPasswordGrantType())
            {
                ...
                {
                    Message = OpenIdConnectConstants.Errors.UnsupportedGrantType,
            ...
            if (user == null)
            {
                return BadRequest(new ApiError
                {
                    Message = OpenIdConnectConstants.Errors.InvalidGrant,
            ...
            if (!await _signInManager.CanSignInAsync(user))
            {
                ...
                {
                    Message = OpenIdConnectConstants.Errors.InvalidGrant,
                    Detail = "The specified user is not allowed to sign in."
                });
            }
