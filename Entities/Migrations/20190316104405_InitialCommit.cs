        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalVolunteerHours = table.Column<decimal>(nullable: false),
                    TotalTravelHours = table.Column<decimal>(nullable: false),
                    OverallVolunteeringHours = table.Column<decimal>(nullable: false),
                    LivesImpacted = table.Column<int>(nullable: false),
                    Status = table.Column<string>(nullable: true),
                    CouncilId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    AllowMultipleAnswer = table.Column<bool>(nullable: false),
                    FreeTextQuestion = table.Column<bool>(nullable: false),
                    CustomQuestion = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventDate = table.Column<string>(nullable: true),
                    NotAttended = table.Column<bool>(nullable: false),
                    Unregistered = table.Column<bool>(nullable: false),
                    Attended = table.Column<bool>(nullable: false),
                    IsEmailSent = table.Column<bool>(nullable: false),
                    MailSentAt = table.Column<DateTime>(nullable: false),
                    IsFeedbackReceived = table.Column<bool>(nullable: false),
                    FeedbackId = table.Column<Guid>(nullable: true),
                    FileId = table.Column<string>(nullable: true),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    ModifiedAt = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    PocId = table.Column<long>(nullable: false),
                    PocName = table.Column<string>(nullable: true),
                    PocContactNumber = table.Column<string>(nullable: true),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    ModifiedAt = table.Column<DateTime>(nullable: false),
                    EventId = table.Column<Guid>(nullable: true)
                },
